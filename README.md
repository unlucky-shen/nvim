...
* LSPs must be updated manually by following these steps,
  ...
  2. Go to the [nvim-lsp-config Github repository](https://github.com/neovim/nvim-lspconfig), navigate to `/nvim-lspconfig/` and look for required lsp. (eg. `pyright.lua`)
